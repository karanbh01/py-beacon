...
class Equity(Asset):
    ...
    **This is the only asset type the index pipeline accepts (BN-185).**
...
def require_equity(asset: Asset,
                   ...
                   action: str) -> Equity:
    """*asset* as an :class:`Equity`, or a refusal (BN-185).

    One answer, at six sites that used to give four. Selection admitted a
